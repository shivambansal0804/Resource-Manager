			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col_half portfolio-single-content col_last nobottommargin">
						...
						<p>DTU ALTAIR (Advance Leap in Technology and Intelligent Robotics) is a team of robotics enthusiasts aiming at developing autonomous robotic solutions.</p>
						...
						<ul class="portfolio-meta bottommargin">
							<li><span><i class="icon-user"></i>Team Captain:</span> Akash Jain</li>
							<li><span><i class="icon-call"></i>Phone Number:</span> +91 9910780884</li>
						</ul>
						...
						<div class="si-share clearfix">
							...
							<div>
								<a href="https://www.facebook.com/dtualtair/" class="social-icon si-borderless si-facebook">
									<i class="icon-facebook"></i>
									<i class="icon-facebook"></i>
								</a>
								<a href="mailto:dtualtair@gmail.com" class="social-icon si-borderless si-email3">
