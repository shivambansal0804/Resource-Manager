			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col_half portfolio-single-content col_last nobottommargin">
						...
						<p>Team Okami Racing, the Electric Motorcycle Team of DTU, aims to design and manufacture high performance electric motorcycles to nurture the advent of full electric - emission free modes of transportation.</p>
						...
						<ul class="portfolio-meta bottommargin">
							<li><span><i class="icon-user"></i>Team Captain:</span> Wajid Ali Shah</li>
						...
						<div class="si-share clearfix">
							...
							<div>
								<a href="https://www.facebook.com/okamiracingteam/" class="social-icon si-borderless si-facebook">
									<i class="icon-facebook"></i>
									<i class="icon-facebook"></i>
								</a>
								<a href="mailto:wajid.scs96@gmail.com" class="social-icon si-borderless si-email3">
