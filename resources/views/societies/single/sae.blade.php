...
@section('content') 
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				<h1>Society for Automotive engineers (SAE-DTU)</h1>
			</div>
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col_half portfolio-single-content col_last nobottommargin">
						...
						<p>SAE(Society of Automotive Engineers) is a non profit engineering and scientific society dedicated to the advancement of mobility community.</p>
						...
						<ul class="portfolio-meta bottommargin">
							<li><span><i class="icon-user"></i>President:</span> Anshul Choudhary</li>
						</ul>
						...
						<div class="si-share clearfix">
							...
							<div>
								<a href="https://www.facebook.com/saeindiadtu/" class="social-icon si-borderless si-facebook">
